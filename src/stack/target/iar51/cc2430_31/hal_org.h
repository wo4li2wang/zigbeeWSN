...
#define SYMBOLS_TO_TICKS(x) (x)   //every
#define MSECS_TO_TICKS(x)   (x*62.5)
#define TIMER_MAX_VALUE 0x000FFFFF   //20 bit counter
#define halMACTimerNowDelta(x) ((halGetMACTimer()-(x))& TIMER_MAX_VALUE)
#define halMACTimerDelta(x,y) ((x-(y))& TIMER_MAX_VALUE)
